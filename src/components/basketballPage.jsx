...
function BasketballPage() {
  ...
  useEffect(() => {
    ...
    dispatch(getBookingsByDateAndName("65a273381c912c4b41ccc4b6", date));
  }, [date]);
  ...
  return (
    <div className="body">
      ...
      <main>
        <div className="basketball-page-hero">
          <svg
            className="svg1"
            xmlns="http://www.w3.org/2000/svg"
            width="820"
            ...
            style={{ color: "white" }}
          >
            <path d="M-3 0H819.5L709.5 206H-3V0Z" fill="#D21034" />
          </svg>
          <div className="cut1">
            <div>Life is about timing</div>
            <div className="cut1-2">Just play.</div>
          </div>
          <div className="b-cut2">
        ...
        <div className="stadiums">
          ...
          <div className="stadiums-terrain">
            <div className="stadiums-terrain-single">
              <img
                src={terrains && terrains[0]?.image}
                alt={terrains && terrains[0]?.name}
              />
              <div>
                <div>{terrains && terrains[0]?.name}</div>
                <div className="dimensions">
                  ({terrains && terrains[0]?.dimensions})
                </div>
              </div>
            </div>
          </div>
